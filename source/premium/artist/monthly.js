...
var db = mongojs('localhost:57017/cyclone_statistic', ['data', 'monthly_artist_premium']);
...
// view output
db.monthly_artist_premium.find(function (err, docs) {
