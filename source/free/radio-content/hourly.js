...
var db = mongojs('localhost:57017/cyclone_statistic', ['data', 'hourly_radio_content_free']);
...
// view output
db.hourly_radio_content_free.find(function (err, docs) {
